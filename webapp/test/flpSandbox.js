		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comsapmzmasterdet-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapmzmasterdet-display": {
								"semanticObject": "comsapmzmasterdet",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.m.zmasterdet",
									"url": sap.ui.require.toUrl("com/sap/m/zmasterdet")
								}
							}
						}
					}
